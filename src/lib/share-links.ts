...
export function enrichExternalSignResponse<T extends Record<string, unknown>>(
  payload: T,
  share: ShareLinks,
): T & ShareLinks & { shareHint: string } {
  return {
    ...payload,
    ...share,
    shareHint:
      "Compartí manualmente por WhatsApp/Telegram o usá whatsappShareUrl / telegramShareUrl.",
  };
}
